...
- Support for various package managers: [npm](https://www.npmjs.com), [Yarn](https://yarnpkg.com), [pnpm](https://pnpm.io), [Bun](https://bun.sh), [Deno](https://deno.com), and [ni](https://github.com/antfu/ni).
